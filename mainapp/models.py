...
class Book(models.Model):
    ...
    img_book = models.ImageField( upload_to='imgs/book/', height_field=None, width_field=None,null=True,blank=True)
    img_author = models.ImageField( upload_to='imgs/book/', height_field=None, width_field=None,null=True,blank=True)
